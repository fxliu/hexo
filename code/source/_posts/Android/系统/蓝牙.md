...
public class EsBleManager {
    ...
    private IStateListener mIBleStateListener = null;
    private BluetoothStateListener mBluetoothStateListener = new BluetoothStateListener() {
        ...
        public void onBluetoothStateChanged(boolean openOrClosed) {
            ...
            if (null != mIBleStateListener) {
                mIBleStateListener.onStateChanged(openOrClosed);
                mIBleStateListener = null;
            }
        }
    };

    public void openBluetooth(IStateListener listener) {
    ...
    public void closeBluetooth(IStateListener listener) {
        if (null == mClient) return;
        if (null != listener) {
            mIBleStateListener = listener;
            mClient.registerBluetoothStateListener(mBluetoothStateListener);
